...
public class HttpsUtils {
    ...
    public static void main(String[] args)  {
        try{
            ...
            //params.put("username","hujiaojiao@seczone.cn");
            //params.put("password","user123!");
            //HttpResponse response = doGet("https://iast.hf.seczone.cn/vulhunter/login","",new HashMap(),params) ;
            ...
            params.put("username","hujiaojiao@seczone.cn");
            params.put("password","user123!");
            HttpResponse response = doPost("https://iast.hf.seczone.cn/vulhunter/login","",new HashMap(),new HashMap(),params) ;
            HttpEntity entity = response.getEntity();
            Header[] headers = response.getAllHeaders();
            System.out.println("");
        }catch (Exception e){
